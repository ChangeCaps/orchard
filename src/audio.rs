use kira::{arrangement::{Arrangement, ArrangementSettings, LoopArrangementSettings, SoundClip, handle::ArrangementHandle}, manager::AudioManager, mixer::SubTrackHandle, sound::{SoundSettings, handle::SoundHandle}};
...
impl Audio {
	...
	pub fn load(audio_manager: &mut AudioManager) -> ike::anyhow::Result<Self> {
		...
		let music = audio_manager.load_sound("assets/audio/OrchardRain.wav", SoundSettings::default())?;
